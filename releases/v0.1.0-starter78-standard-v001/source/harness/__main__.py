...
def main():
    ...
    p=commands.add_parser("freeze");p.add_argument("--run",required=True);p.add_argument("--version",required=True);p.add_argument("--knowledge",required=True);p.add_argument("--baseline");p.add_argument("--previous");p.add_argument("--renders")

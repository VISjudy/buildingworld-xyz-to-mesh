...
- 2026-09-22 按用户授权对比赛4000输入运行initial v0.1.0：3966个网格＋34个失败空OBJ，已打包并校验，未上传。包在 `../submissions/2026-09-22-initial-v0.1.0-test4000/`，报告 `reports/2026-09-22-initial-v010-test4000/`；完整配对432/130仍锁定。
